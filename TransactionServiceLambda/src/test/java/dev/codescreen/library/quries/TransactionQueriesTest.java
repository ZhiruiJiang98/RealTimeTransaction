...
public class TransactionQueriesTest {
    ...
    private static final String TEST_UPDATED_TIME = "2021-08-01T00:00:00Z";
    ...
    private static final String EXPECTED_CREATE_TRANSACTION =
            "INSERT INTO Transaction (id, accountId, messageId, amount, currency, updatedTime, createdTime, debitOrCredit, transactionStatus) VALUES ('testId', 'testAccountId', 'messageId','1000.00', 'USD', '2021-08-01T00:00:00Z', '2021-08-01T00:00:00Z', 'DEBIT', 'PENDING')";
    private static final String EXPECTED_GET_TRANSACTION_COUNT = "SELECT COUNT(messageId) FROM Transaction WHERE messageId = 'messageId'";
    ...
    private static final Map<TransactionResultSet, Object> UPDATE_FIELDS = Map.of(
            ...
            TransactionResultSet.UPDATE_TIME, TEST_UPDATED_TIME,
    ...
    public  void test_create_transaction(){
        assertEquals(EXPECTED_CREATE_TRANSACTION, TransactionQueries.createTransaction(TEST_ID, TEST_ACCOUNT_ID,TEST_MESSAGE_ID, TEST_AMOUNT, TEST_CURRENCY, TEST_UPDATED_TIME, TEST_CREATED_TIME, TEST_ENTRY_STATUS, TEST_STATUS));
    }
